                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="Project ABC" readonly>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" value="2022-12-28" readonly>
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><strong>Description / 描述:</strong></label>
                            <textarea class="form-control" rows="3" readonly>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control available-quantity"
                                           name="available_quantity[{{ $i }}]" value="0" min="0" />
                                </td>
                                <td>
