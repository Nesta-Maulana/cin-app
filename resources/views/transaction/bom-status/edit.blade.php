    ...
    <div class="col-md-9 mx-md-auto">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('bom-status.index') }}" class="btn p-0" title="Kembali">
                    <i class="ti ti-x ti-sm text-muted"></i>
                </a>
            </div>

            <div class="card-body">
                <form action="{{ route('bom-status.update', $data->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="my-2">
                        ...
                        <a href="{{ route('bom-status.index') }}" class="btn btn-label-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
