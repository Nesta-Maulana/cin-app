            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="card-title mb-0">
                        ...
                        <small class="text-muted">Buat @yield('title') / 创建@yield('title')</small>
                    </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="text" id="name" name="name"
                                    value="{{ old('name') }}" placeholder="Enter Name / 输入名称" autofocus required />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="text" id="slug" name="slug"
                                    value="{{ old('slug') }}" placeholder="Enter Slug / 输入网址别名" maxlength="3" required />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <select class="form-select" id="is_active" name="is_active" required>
                                    <option value="1" {{ old('is_active', true) ? 'selected' : '' }}>Active / 启用
                                    </option>
                                    <option value="0" {{ old('is_active', true) == '0' ? 'selected' : '' }}>Inactive /
                                        不启用</option>
                                </select>
                            </div>
                        </div>
