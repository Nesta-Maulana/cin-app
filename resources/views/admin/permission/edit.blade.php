        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="card-title mb-0">
                    ...
                    <small class="text-muted">Update Permission / 更新权限</small>
                </div>
                ...
                <form action="{{ route('permission.update', $data->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <input class="form-control" type="text" id="name" name="name" value="{{ old('name', $data->name) }}"
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <select class="form-select" id="guard_name" name="guard_name" required>
                                <option value="web" {{ old('guard_name', $data->guard_name) == 'web' ? 'selected' : '' }}>web</option>
                                <option value="api" {{ old('guard_name', $data->guard_name) == 'api' ? 'selected' : '' }}>api</option>
                                <option value="sanctum" {{ old('guard_name', $data->guard_name) == 'sanctum' ? 'selected' : '' }}>sanctum</option>
                            </select>
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input class="form-control" type="text" id="group" name="group" value="{{ old('group', $data->group) }}"
