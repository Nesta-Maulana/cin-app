                ...
                <form action="{{ route('setting.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{ asset('Thumbnail.jpg') }}" alt="logo" class="d-block w-px-100 h-px-100 rounded"
                                id="uploadedAvatar">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-8">
                            ...
                            <input class="form-control" type="text" id="name" name="app_name"
                                value="{{ old('app_name') }}" placeholder="Nama App" autofocus required />
                        </div>

                        <div class="mb-3 col-md-4">
                            <label for="version" class="form-label">Versi</label>
                            <input class="form-control" type="text" id="version" name="app_version"
                                value="{{ old('app_version') }}" placeholder="v1.0" />
                        </div>

                        <div class="mb-3 col-md-12">
                            <label for="name" class="form-label">Nama Insitusi</label>
                            <input class="form-control" type="text" id="name" name="name" value="{{ old('name') }}"
                                placeholder="Nama Insitusi" required />
                        </div>

                        <div class="mb-3 col-md-12">
                            <label for="address" class="form-label">Alamat Insitusi</label>
                            <textarea class="form-control" name="address" id="address" rows="4"
                                placeholder="Alamat Insitusi"></textarea>
                        </div>
                    </div>
