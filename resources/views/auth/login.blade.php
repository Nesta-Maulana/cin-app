                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <a class="brand-logo" href="#">
                            <img src="{{ siteLogo() }}" alt="Logo" style="width: 60px;">
                            <h2 class="brand-text text-primary ms-1" style="line-height: 50px">{{ appName() }}</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid" src="{{ asset('theme/app-assets/images/pages/login-v2.svg') }}"
                                    alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text"
                                            ...
                                            id="email" name="email_or_username"
                                            value="{{ old('email_or_username') }}" tabindex="1" placeholder="Email or Username"
                                            required autofocus />
