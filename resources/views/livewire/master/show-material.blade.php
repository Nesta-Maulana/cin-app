        ...
        <div class="card-header border-bottom d-md-flex justify-content-md-between align-items-md-center">
            ...
            <div class="text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column">
                ...
                <div class="flex-wrap my-1">
                    <a href="{{ route('material.create') }}" class="btn btn-secondary text-white add-new btn-primary">
                        <span>
            ...
            <table class="table border-top">
                <thead>
                    <tr>
                        ...
                        @endcan
                        <th>Material Name</th>
                        <th>Material Name in Mandarin</th>
                        <th>Material Code</th>
                        <th>Material Unit</th>
                ...
                <tbody>
                    ...
                    @php
                    $updateRoute = route('material.update', $item->id);
                    @endphp
                    ...
                    <tr wire:key="row{{ $item->id }}">
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                @can('update-material')
                                    <a href="{{ route('material.edit', $item->id) }}" class="action-btn" title="edit">
