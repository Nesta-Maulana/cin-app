            ...
            <div class="text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column">
                ...
                @can('create-unit-of-measurement')
                    <div class="flex-wrap my-1">
                        <a href="{{ route('unit-of-measurement.create') }}"
            ...
            <table class="table border-top">
                ...
                <tbody>
                    ...
                    @forelse($table as $key => $item)
                        @php
                            $updateRoute = route('unit-of-measurement.update', $item->id);
                        @endphp
                        ...
                        <tr wire:key="row{{ $item->id }}">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    @can('update-unit-of-measurement')
                                        <a href="{{ route('unit-of-measurement.edit', $item->id) }}" class="action-btn"
                                            title="edit">
                                            <i class="fa fa-edit fa-sm me-2 fs-5"></i>
                                        </a>
                                    @endcan

                                    @can('delete-unit-of-measurement')
