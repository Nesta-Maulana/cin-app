            ...
            <div class="text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column">
                ...
                @can('create-item-type')
                    <div class="flex-wrap my-1">
                        <a href="{{ route('item-type.create') }}" class="btn btn-secondary text-white add-new btn-primary">
                            <span>
            ...
            <table class="table border-top">
                ...
                <tbody>
                    ...
                    @forelse($table as $key => $item)
                        @php
                            $updateRoute = route('item-type.update', $item->id);
                        @endphp
                        ...
                        <tr wire:key="row{{ $item->id }}">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    @can('update-item-type')
                                        <a href="{{ route('item-type.edit', $item->id) }}" class="action-btn"
                                            title="edit">
