        ...
        <div class="card-header border-bottom d-md-flex justify-content-md-between align-items-md-center">
            ...
            <div class="text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column">
                ...
                <div class="flex-wrap my-1">
                    <a href="{{ route('approval-level.create') }}" class="btn btn-secondary text-white add-new btn-primary">
                        <span>
        ...
        <div class="table-responsive">
            <table class="table border-top">
                ...
                <tbody>
                    ...
                    @php
                    $updateRoute = route('approval-level.update', $item->id);
                    @endphp
                    ...
                    <tr wire:key="row{{ $item->id }}">
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                @can('update-approval-level')
                                    <a href="{{ route('approval-level.edit', $item->id) }}" class="action-btn" title="edit">
