                ...
                @if (!$selected)
                    ...
                    @can('create-unit')
                        <div class="flex-wrap my-1">
                            <a href="{{ route('unit.create') }}" class="btn btn-secondary text-white add-new btn-primary">
                                <span>
            ...
            <table class="table border-top">
                ...
                <tbody>
                    @forelse($table as $key => $item)
                        @php
                            $updateRoute = route('unit.update', $item->id);
                        @endphp
                        ...
                        <tr wire:key="row{{ $item->id }}">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    @can('update-unit')
                                        <a href="{{ route('unit.edit', $item->id) }}" class="action-btn" title="edit">
