                        ...
                        <tr wire:key="row{{ $item->id }}" class="text-center">
                            ...
                            <td>
                                @if ($item->permissions->count() > 0)
                                    {{ $item->permissions->count() }} of {{ $total_permission }} permission
                                @else
                                ...
                                <div class="d-flex align-items-center">
                                    @can('update-role')
                                        <a href="{{ route('role.edit', $item->id) }}" class="action-btn" title="edit">
                                            <i class="fa fa-edit ti-sm me-2 fs-5"></i>
                                        </a>
                                    @endcan
                                    ...
                                    @can('delete-role')
                                        <a href="javascript:;" class="action-btn" title="delete" data-bs-toggle="modal"
                                            ...
                                            <i class="fa fa-trash ti-sm mx-2 fs-5"></i>
                                        </a>
