    ...
    <div class="card">
        <div class="card-header border-bottom d-md-flex justify-content-md-between align-items-md-center">
            ...
            <div class="text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column">
                ...
                @can('create-delivery-order-detail')
                <div class="flex-wrap my-1">
                    <a href="{{ route('delivery-order-detail.create') }}" class="btn btn-secondary text-white add-new btn-primary">
                        <span>
        ...
        <div class="table-responsive">
            <table class="table border-top">
                <thead>
                    <tr>
                        @can('update-delivery-order-detail')
                            <th>
                ...
                <tbody>
                    ...
                    @php
                    $updateRoute = route('delivery-order-detail.update', $item->id);
                    @endphp
                    ...
                    <tr wire:key="row{{ $item->id }}">
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                @can('update-delivery-order-detail')
                                    <a href="{{ route('delivery-order-detail.edit', $item->id) }}" class="action-btn" title="edit">
                                        <i class="fa fa-edit fa-sm me-2 fs-5"></i>
                                    </a>
                                @endcan

                                @can('delete-delivery-order-detail')
