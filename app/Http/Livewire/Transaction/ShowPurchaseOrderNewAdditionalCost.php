...
use App\Models\PurchaseOrderNewAdditionalCost as Model;
...
class ShowPurchaseOrderNewAdditionalCost extends Component
{
    use LivewireAlert;
    use WithPagination;
    ...
    public function mount(PurchaseOrderNewAdditionalCostRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(PurchaseOrderNewAdditionalCostRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-purchase-order-new-additional-cost', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
