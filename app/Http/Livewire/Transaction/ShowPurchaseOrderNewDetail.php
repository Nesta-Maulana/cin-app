...
class ShowPurchaseOrderNewDetail extends Component
{
    ...
    public function mount(PurchaseOrderNewDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(PurchaseOrderNewDetailRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-purchase-order-new-detail', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
