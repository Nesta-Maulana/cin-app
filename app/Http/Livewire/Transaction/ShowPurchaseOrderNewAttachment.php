...
class ShowPurchaseOrderNewAttachment extends Component
{
    ...
    public function mount(PurchaseOrderNewAttachmentRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(PurchaseOrderNewAttachmentRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-purchase-order-new-attachment', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
