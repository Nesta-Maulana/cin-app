...
class ShowManualItemRequestDetail extends Component
{
    ...
    public function mount(ManualItemRequestDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(ManualItemRequestDetailRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-manual-item-request-detail', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
