...
use App\Models\PrePurchaseOrder as Model;
...
class ShowPrePurchaseOrder extends Component
{
    ...
    public function mount(PrePurchaseOrderRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(PrePurchaseOrderRepositoryInterface::class);
    }
