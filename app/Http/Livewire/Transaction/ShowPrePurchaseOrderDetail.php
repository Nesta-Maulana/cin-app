...
class ShowPrePurchaseOrderDetail extends Component
{
    ...
    public function mount(PrePurchaseOrderDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(PrePurchaseOrderDetailRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-pre-purchase-order-detail', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
