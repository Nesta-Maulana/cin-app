...
class ShowApprovalRequest extends Component
{
    ...
    public function mount(ApprovalRequestRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(ApprovalRequestRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-approval-request', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
