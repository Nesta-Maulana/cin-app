...
class ShowDeliveryOrder extends Component
{
    use LivewireAlert;
    use WithPagination;
    ...
    public function mount(DeliveryOrderRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(DeliveryOrderRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-delivery-order', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
