...
class ShowItemNeedToPurchaseDetail extends Component
{
    ...
    public function mount(ItemNeedToPurchaseDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(ItemNeedToPurchaseDetailRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-item-need-to-purchase-detail', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
