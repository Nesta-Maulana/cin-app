...
class ShowItemRequestDetail extends Component
{
    ...
    public function mount(ItemRequestDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(ItemRequestDetailRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-item-request-detail', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
