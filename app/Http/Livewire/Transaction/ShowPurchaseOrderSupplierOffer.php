...
class ShowPurchaseOrderSupplierOffer extends Component
{
    ...
    public function mount(PurchaseOrderSupplierOfferRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(PurchaseOrderSupplierOfferRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-purchase-order-supplier-offer', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
