...
class ShowPurchaseOrderDetail extends Component
{
    ...
    public function mount(PurchaseOrderDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(PurchaseOrderDetailRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-purchase-order-detail', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
