...
use App\Models\PurchaseOrderSupplierOfferDetail as Model;
...
class ShowPurchaseOrderSupplierOfferDetail extends Component
{
    use LivewireAlert;
    use WithPagination;
    ...
    public function mount(PurchaseOrderSupplierOfferDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(PurchaseOrderSupplierOfferDetailRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-purchase-order-supplier-offer-detail', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
