...
use App\Models\QuotationComparison as Model;
...
class ShowQuotationComparison extends Component
{
    ...
    public function mount(QuotationComparisonRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(QuotationComparisonRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-quotation-comparison', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
