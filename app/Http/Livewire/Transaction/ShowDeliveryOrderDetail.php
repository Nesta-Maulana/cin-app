...
class ShowDeliveryOrderDetail extends Component
{
    ...
    public function mount(DeliveryOrderDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(DeliveryOrderDetailRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-delivery-order-detail', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
