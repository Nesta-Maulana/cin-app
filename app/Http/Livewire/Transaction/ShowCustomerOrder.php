...
class ShowCustomerOrder extends Component
{
    ...
    public function mount(CustomerOrderRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(CustomerOrderRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-customer-order', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
