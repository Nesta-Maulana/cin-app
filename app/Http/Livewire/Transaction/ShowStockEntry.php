...
class ShowStockEntry extends Component
{
    ...
    public function mount(StockEntryRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(StockEntryRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.transaction.show-stock-entry', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
