...
class ShowUnitOfMeasurement extends Component
{
    ...
    public function mount(UnitOfMeasurementRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(UnitOfMeasurementRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.master.show-unit-of-measurement', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
