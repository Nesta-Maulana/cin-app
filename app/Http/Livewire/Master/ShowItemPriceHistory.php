...
class ShowItemPriceHistory extends Component
{
    ...
    public function mount(ItemPriceHistoryRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(ItemPriceHistoryRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.master.show-item-price-history', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
