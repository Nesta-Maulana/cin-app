...
class ShowApproval extends Component
{
    ...
    public function mount(ApprovalRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(ApprovalRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.master.show-approval', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
