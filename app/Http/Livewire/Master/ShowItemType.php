...
class ShowItemType extends Component
{
    use LivewireAlert;
    use WithPagination;
    ...
    public function mount(ItemTypeRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(ItemTypeRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.master.show-item-type', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
