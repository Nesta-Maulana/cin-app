...
class ShowMaterial extends Component
{
    ...
    public function mount(MaterialRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(MaterialRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.master.show-material', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
