...
class ShowItemUom extends Component
{
    ...
    public function mount(ItemUomRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(ItemUomRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.master.show-item-uom', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
