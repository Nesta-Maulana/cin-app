...
class ShowJobCategory extends Component
{
    use LivewireAlert;
    use WithPagination;
    ...
    public function mount(JobCategoryRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(JobCategoryRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.master.show-job-category', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
