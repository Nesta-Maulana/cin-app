...
class ShowItemCategory extends Component
{
    ...
    public function mount(ItemCategoryRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(ItemCategoryRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.master.show-item-category', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
