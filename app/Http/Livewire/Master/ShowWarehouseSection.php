...
class ShowWarehouseSection extends Component
{
    ...
    public function mount(WarehouseSectionRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(WarehouseSectionRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('livewire.master.show-warehouse-section', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
