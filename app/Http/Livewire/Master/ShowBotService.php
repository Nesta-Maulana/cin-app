...
class ShowBotService extends Component
{
    ...
    public function mount(BotServiceRepositoryInterface $repository)
    {
        $this->repository = $repository;
    }
    public function hydrate()
    {
        $this->repository = app(BotServiceRepositoryInterface::class);
    }
    ...
    public function render()
    {
       try {
            ...
            return view('master.show-bot-service', [
                'table' => $table,
            ]);
        } catch (\Exception $e) {
