...
{
    public $view, $route;
    protected $repository, $jobCategoryRepository, $customerRepository;
    public function __construct(CustomerOrderRepositoryInterface $repository, JobCategoryRepositoryInterface $jobCategoryRepository, CustomerRepositoryInterface $customerRepository)
    {
    ...
    public function create()
    {
        ...
        return view("{$this->view}.create", compact('jobCategories', 'customers'));
    }
