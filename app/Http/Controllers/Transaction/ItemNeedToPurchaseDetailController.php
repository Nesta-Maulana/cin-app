...
class ItemNeedToPurchaseDetailController extends Controller
{
    public $view, $route;
    protected $repository;
    public function __construct(ItemNeedToPurchaseDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
        $this->view = 'transaction.itemneedtopurchasedetail';
        $this->route = '';
