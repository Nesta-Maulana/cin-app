...
class PurchaseOrderSupplierOfferDetailController extends Controller
{
    public $view, $route;
    protected $repository;
    public function __construct(PurchaseOrderSupplierOfferDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
        $this->view = 'transaction.purchaseordersupplierofferdetail';
        $this->route = '';
