...
class ManualItemRequestDetailController extends Controller
{
    public $view, $route;
    protected $repository;
    public function __construct(ManualItemRequestDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
        $this->view = 'transaction.manualitemrequestdetail';
        $this->route = '';
