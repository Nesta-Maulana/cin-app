...
class PrePurchaseOrderDetailController extends Controller
{
    public $view, $route;
    protected $repository;
    public function __construct(PrePurchaseOrderDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
        $this->view = 'transaction.prepurchaseorderdetail';
        $this->route = '';
