...
class PurchaseOrderNewAdditionalCostController extends Controller
{
    public $view, $route;
    protected $repository;
    public function __construct(PurchaseOrderNewAdditionalCostRepositoryInterface $repository)
    {
        $this->repository = $repository;
        $this->view = 'transaction.purchaseordernewadditionalcost';
        $this->route = '';
