...
class PurchaseOrderNewDetailController extends Controller
{
    public $view, $route;
    protected $repository;
    public function __construct(PurchaseOrderNewDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
        $this->view = 'transaction.purchaseordernewdetail';
        $this->route = '';
