...
class QuotationComparisonDetailController extends Controller
{
    public $view, $route;
    protected $repository;
    public function __construct(QuotationComparisonDetailRepositoryInterface $repository)
    {
        $this->repository = $repository;
        $this->view = 'transaction.quotationcomparisondetail';
        $this->route = '';
